...
export class CСhangeIMG{
    ...
    avatar:HTMLImageElement|null=document.querySelector(".chimg__img__user__avatar")
    inputFileAvatar:HTMLInputElement|null=document.querySelector(".chimg__input__file")
    ...
    updateUserAvatar(){
        ...
        butChIMG?.addEventListener("click",(e)=>{
            ...
            this.HTTPTransport.put("user/profile/avatar",{method:"PUT",data:formData}).then((ans)=>{
                if(this.avatar){
