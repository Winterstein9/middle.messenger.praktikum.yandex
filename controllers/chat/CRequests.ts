...
export class CRequests{
    ...
    requestAddNewChat(chatName:string){
        return this.HTTPTransport.post("chats",{method:"POST", data:{title:chatName}})
    }
    ...
    requestDelChat(chatID:string|null){
        return this.HTTPTransport.delete("/chats",{method:"DELETE",data:{chatId:chatID}})
    }
    
    requestAddUserToChat(userID:string|null, chatID:string|null){
        return this.HTTPTransport.put("/chats/users",{method:"PUT",data:{users:[userID],chatId:chatID}})
    }

    requestDelUserFromChat(userID:string|null, chatID:string|null){
        return this.HTTPTransport.delete("/chats/users",{method:"DELETE",data:{users:[userID],chatId:chatID}})
    }
    ...
    requestSerchUsers(userName:string|null){
        return this.HTTPTransport.post("/user/search",{method:"POST", data:{login:userName}})
    }
